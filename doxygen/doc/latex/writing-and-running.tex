...
\label{writing-and-running}\index{Writing and Running Tests@{Writing and Running Tests}}
\hypertarget{writing-and-running_writing-new-tests}{}\doxysection{\texorpdfstring{Writing a new test}{Writing a new test}}\label{writing-and-running_writing-new-tests}
...
\DoxyCodeLine{add\_subdirectory(src/example-\/test)}

\end{DoxyCode}


Please check the {\ttfamily icub-\/tests/example} folder for a template for developing tests for the i\+Cub.\hypertarget{writing-and-running_running_single_test_case}{}\doxysection{\texorpdfstring{Running a single test case}{Running a single test case}}\label{writing-and-running_running_single_test_case}
...
Notice that the environment parameter {\ttfamily -\/-\/robotname icub\+Sim} is used to locate the correct context (for this examples is {\ttfamily icub\+Sim}) and also to update the variables loaded from the {\ttfamily right\+\_\+camera.\+ini} file.\hypertarget{writing-and-running_running_multiple_tests}{}\doxysection{\texorpdfstring{Running multiple tests using a test suite}{Running multiple tests using a test suite}}\label{writing-and-running_running_multiple_tests}
...
How {\ttfamily robottestingframework-\/testrunner} knows that it should launch the i\+Cub simulator before running the tests? Well, this is indicated by {\ttfamily \texorpdfstring{$<$}{<}fixture param="{}-\/-\/fixture icubsim-\/fixture.\+xml"{}\texorpdfstring{$>$}{>} yarpmanager \texorpdfstring{$<$}{<}/fixture\texorpdfstring{$>$}{>}}. The {\ttfamily robottestingframework-\/testrunner} uses the {\ttfamily yarpmanager} fixture plug-\/in to launch the modules which are listed in the {\ttfamily icubsim-\/fixture.\+xml}. Notice that all the fixture files should be located in the {\ttfamily icub-\/tests/suites/fixtures} folder. 