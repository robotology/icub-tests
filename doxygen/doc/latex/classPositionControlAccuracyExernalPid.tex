...
\PBS\centering Max\+Value &\PBS\centering double &\PBS\centering \% &\PBS\centering 100 &\PBS\centering No &\PBS\centering max value for P\+ID output (saturator). &\PBS\centering \\\cline{1-7}
\end{longtabu}
