\chapter{IMU orientation test}
\label{md__2home_2runner_2work_2icub-tests_2icub-tests_2gh-pages_2src_2imu_2README}\index{IMU orientation test@{IMU orientation test}}
...
An example of {\ttfamily alljoints-\/inertials\+\_\+wrapper.\+xml} for i\+Cub\+V2\+\_\+\texorpdfstring{$\ast$}{*} models\+:
