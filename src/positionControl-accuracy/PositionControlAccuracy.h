...
* The data acquired can be analized with a matalab script to evaluate the position PID properties.
* Be aware that a step greater than 5 degrees at the maximum speed is dangerous for both the robot and the human operator!
